...
public interface SessionListenerContainer {
  ...
  /**
   * Returns whether a {@link SessionListener} is already in the collection of {@link
   * SessionListener}s to be notified
   *
   * @param sessionListener The {@link SessionListener} to look for
   * @return {@code true} if the {@link SessionListener} is already in the collection of {@link
   *     SessionListener}s to be notified, otherwise {@code false}
   */
