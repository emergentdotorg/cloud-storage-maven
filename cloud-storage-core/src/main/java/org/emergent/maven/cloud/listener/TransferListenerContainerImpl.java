...
package org.emergent.maven.cloud.listener;
...
public class TransferListenerContainerImpl implements TransferListenerContainer {
  ...
  public void fireTransferInitiated(Resource resource, int requestType) {
    TransferEvent transferEvent =
        new TransferEvent(this.wagon, resource, TransferEvent.TRANSFER_INITIATED, requestType);
  ...
  public void fireTransferStarted(Resource resource, int requestType, File localFile) {
    ...
    TransferEvent transferEvent =
        new TransferEvent(this.wagon, resource, TransferEvent.TRANSFER_STARTED, requestType);
  ...
  public void fireTransferProgress(Resource resource, int requestType, byte[] buffer, int length) {
    TransferEvent transferEvent =
        new TransferEvent(this.wagon, resource, TransferEvent.TRANSFER_PROGRESS, requestType);
  ...
  public void fireTransferCompleted(Resource resource, int requestType) {
    TransferEvent transferEvent =
        new TransferEvent(this.wagon, resource, TransferEvent.TRANSFER_COMPLETED, requestType);
