...
public interface TransferListenerContainer {
  ...
  /**
   * Returns whether a {@link TransferListener} is already in the collection of {@link
   * TransferListener}s to be notified
   *
   * @param transferListener the {@link TransferListener} to look for
   * @return {@code true} if the {@link TransferListener} is already in the collection of {@link
   *     TransferListener}s to be notified, otherwise {@code false}
   */
