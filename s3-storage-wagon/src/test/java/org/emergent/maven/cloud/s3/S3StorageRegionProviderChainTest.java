...
public class S3StorageRegionProviderChainTest {
    ...
    private final ChainFactory factory = reg -> new S3StorageRegionProviderChain(reg,
    ...
    public void testSystemPropertyRegion() {
        sysPropProvRef.set(getOrDef(AWS_REGION_SYSTEM_PROPERTY, SYSTEM_PROPERTY_REGION, System::getProperty));
        final S3StorageRegionProviderChain regionProvider = factory.getInstance();
    ...
    private static Function<String, String> getOrDef(Map<String, String> map, Function<String, String> f) {
