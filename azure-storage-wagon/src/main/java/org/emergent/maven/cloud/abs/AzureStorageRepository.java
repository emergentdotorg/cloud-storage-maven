...
import static org.emergent.maven.cloud.abs.ContentTypeResolver.getContentType;
...
public class AzureStorageRepository {
  ...
  public void copy(String resourceName, File destination, TransferProgress transferProgress)
    ...
    LOGGER.log(
        Level.FINER,
        String.format(
            "Downloading key %s from container %s into %s",
            resourceName, container, destination.getAbsolutePath()));
